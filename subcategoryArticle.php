	...
	<div class="uk-banner-title uk-article<?= tr_taxonomies_field('suffix', 'category', $thiscat->parent) ?> uk-grid-collapse uk-opensan-bold" uk-grid>
		<div class="uk-width-auto uk-padding-xsmall boundary-align-1 uk-box-shadow-medium">
			<div class="uk-inline">
				<div><span class="uk-margin-right"><?= get_cat_name( $thiscat->parent ) ?></span> <span uk-icon="icon: menu"></span></div>
	...
	<div class="uk-margin uk-margin-large-bottom uk-grid-small" uk-grid>
	...
	<?php endwhile; ?>
		...
		<div class="uk-width-1-1 uk-flex uk-flex-center uk-padding-small uk-padding-remove-vertical uk-margin-small uk-article<?= tr_taxonomies_field('suffix', 'category', $thiscat->parent) ?> uk-article-button uk-animation-toggle">
